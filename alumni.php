...
<?php
$query = "SELECT * FROM tbl_studentdata WHERE student_scholarship = 'ALUMNI'";

$check = mysqli_query($conn,"SELECT * FROM tbl_studentdata WHERE student_scholarship ='ALUMNI'");
