<!--
  Displays all clerical assistant
-->
<html>
  <head>
<script>
...
<?php
$query = "SELECT * FROM tbl_studentdata WHERE student_scholarship = 'Clerical Assistant'";

$check = mysqli_query($conn,"SELECT * FROM tbl_studentdata WHERE student_scholarship ='Clerical Assistant'");
